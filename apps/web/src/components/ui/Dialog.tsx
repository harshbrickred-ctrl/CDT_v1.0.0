      ...
      {open && (
        <div className="fixed inset-0 z-[100] flex items-start justify-center overflow-y-auto p-4 sm:items-center sm:p-6">
          ...
          <motion.div
            ...
            className={`relative z-10 my-auto max-h-[min(90vh,900px)] w-full overflow-y-auto rounded-2xl border border-border/80 bg-card p-5 shadow-[0_32px_80px_-24px_hsl(222_28%_16%_/_0.35)] sm:p-6 ${
