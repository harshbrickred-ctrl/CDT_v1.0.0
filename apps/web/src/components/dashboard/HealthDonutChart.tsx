...
export default function HealthDonutChart({
  ...
  return (
    <PageSection title="Engagement health">
      <Card accent className="!p-4 sm:!p-6">
        <div className="grid gap-6 lg:grid-cols-[1fr_200px] lg:items-center">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-center justify-between border-t border-border/70 pt-3 text-sm font-semibold">
              <span>Total</span>
